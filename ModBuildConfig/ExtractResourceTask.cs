...
public sealed class ExtractResourceTask : Task
{
    [Required]
    ...
    static ExtractResourceTask()
    {
        AppDomain.CurrentDomain.AssemblyResolve += (_, e) => Assembly.LoadFile(Path.Combine(typeof(ExtractResourceTask).Assembly.Location, "..", $"{e.Name}.dll"));
    }
